...
INSERT INTO user_data(id, password, name, mail, role, is_student)
VALUES
...
INSERT INTO course(id, name, points, num_students, num_exercises, used_exercises, semester_name, lecturer_id)
VALUES
    ("000000000-0", 'Math 1', 5.5, 20, 54, 23, 'אביב 2024', 111111111),
    ("000000000-1", 'Math 2', 5.5, 20, 70, 0, 'אביב 2024', 111111111);

INSERT INTO user_course_privileges(user_id, course_id)
VALUES
    (333333333, "000000000-0"),
    (111111111, "000000000-0");